...
class ScholarshipsControllerTest < ActionController::TestCase
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post :create, scholarship: { ending: @scholarship.ending, starting: @scholarship.starting, student_id: @scholarship.student_id }
    end
  ...
  test "should update scholarship" do
    patch :update, id: @scholarship, scholarship: { ending: @scholarship.ending, starting: @scholarship.starting, student_id: @scholarship.student_id }
    assert_redirected_to scholarship_path(assigns(:scholarship))
  end
